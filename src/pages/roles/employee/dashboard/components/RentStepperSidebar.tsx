              ...
              <div key={step.id} className="flex items-center gap-3">
                <div className="flex-shrink-0">
                  {isCompleted ? (
                    ...
                    <div className="h-5 w-5 rounded-full border-2 border-green-600 bg-green-50 flex items-center justify-center text-green-600 text-xs font-medium">
                      {step.id}
                    </div>
                  ) : (
        ...
        <CardContent className="space-y-4">
          ...
          {clientDetails && (
            <div className="p-3 bg-green-50 rounded-md">
              <div className="font-medium text-green-800 mb-1">Patient:</div>
                ...
                <div className="space-y-2">
                  {selectedProducts.map((product, index) => (
                    <div key={index} className="flex justify-between items-start text-sm p-2 bg-gray-50 rounded">
                      ...
                      <div className="font-medium text-green-600 ml-2">
          ...
          <div className="space-y-2">
            ...
            <div className="flex justify-between text-sm">
              ...
              <span className="font-semibold text-lg text-green-600">{dailyTotal.toFixed(2)} DT/jour</span>
            </div>
