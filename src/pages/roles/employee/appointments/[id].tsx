        ...
        <Card>
          <CardContent className="flex items-center justify-center py-12">
            <div className="text-center">
              ...
              <Button onClick={() => router.push('/roles/employee/dashboard')}>
                ...
                {clientPhone && (
                  <div>
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <a href={`tel:${clientPhone}`} className="font-medium text-green-600 hover:underline">
                        {clientPhone}
                      </a>
                    </div>
                  </div>
                ...
                {clientEmail && (
                  <div>
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <a href={`mailto:${clientEmail}`} className="font-medium text-green-600 hover:underline">
                        {clientEmail}
                      </a>
                    </div>
                  </div>
...
AppointmentDetailPage.getLayout = function getLayout(page: React.ReactElement) {
