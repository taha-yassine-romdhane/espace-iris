...
const AdminChat: React.FC = () => {
        ...
        return (
            <div className="p-6 flex items-center justify-center min-h-screen">
                <div className="flex items-center space-x-2">
                    ...
                    <span className="text-blue-700">Chargement des messages...</span>
                </div>
            </div>
        );
    }
    ...
    return (
        <div className="p-6">
            <div className="flex h-[calc(100vh-8rem)] bg-white rounded-lg border border-blue-200 overflow-hidden">
                {/* Conversations List */}
                        ...
                        {conversations.length > 0 ? (
                            conversations.map((conversation) => (
                                <div
                                    ...
                                    className={cn(
                                        "p-4 border-b border-blue-100 cursor-pointer hover:bg-blue-50 transition-colors",
