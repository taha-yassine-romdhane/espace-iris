...
interface ParametreVIFormProps {
  onSubmit: (values: any) => void;
  initialValues?: any;
}

export default function ParametreVIForm({ onSubmit, initialValues }: ParametreVIFormProps) {
  ...
  return (
    <form className="bg-white rounded-xl p-6 w-full max-w-md mx-auto space-y-4" onSubmit={handleSubmit(onSubmit)}>
      <h2 className="text-2xl font-bold mb-2">paramètre VI</h2>
      <div>
