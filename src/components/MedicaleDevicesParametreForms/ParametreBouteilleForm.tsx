...
interface ParametreBouteilleFormProps {
  onSubmit: (values: any) => void;
  initialValues?: any;
}

export default function ParametreBouteilleForm({ onSubmit, initialValues }: ParametreBouteilleFormProps) {
  ...
  return (
    <form className="bg-white rounded-xl p-6 w-full max-w-xs mx-auto space-y-4" onSubmit={handleSubmit(onSubmit)}>
      <h2 className="text-2xl font-bold mb-2">paramètre Bouteille</h2>
      <div>
